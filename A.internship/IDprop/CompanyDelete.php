...
<head>
	...
	<title>IDprop - Delete Company Account</title>
	<meta charset="utf-8">
	...
	<center style="margin-top: 140px;width: 100%:">
		<div class="col col-6" >
			<a id="m_1_2" class="project-item completed" >
				...
				<span class="title">This is where you can delete your IDprop Company Account.</span>
				<span>Deleting means all company, employee, landlord and tenant data will be erased.</span><br><br>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				We hate to see you leaving, are you sure you wish to delete your company account and all associated data?<br>
...
<script>
	function companyProfileDeleteVM() {
		...
		self.deleteMe = function(){
			...
			.done(function(data){
				self.confirmDeleteModal(null);
				if(data){
					location.href = 'companyAccountDeleted.php';
				}
			})
		}
		...
		function deleteUser() {
			var d = $.Deferred()
			$.post('actions/companyDelete.php',{'type':'normalUser','FORM_TOKEN' : FORM_TOKEN
		}).done(function(data) {
			if (data.status == 'ok') {
...
var em = document.getElementById('companyDeletePage');
if(em) ko.applyBindings(new companyDeleteVM(), em);
</script>