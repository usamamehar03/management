...
//This is a rare exception. It won't happen every month. We'll implement AFTER montly tenant rent invoices and MFs.
...
//insert tested and working: We'll use this soon. When we send automated system message telling te uesr to login
  	 	...
  	 	-- if user is late
			...
			--Line 44 has syntax error.  Also 45&47 we don't create new invoice for ManagementFees so should be zero	
				...
				WHEN COUNT(InvoiceDetailsID.Purpose='TenantLateFees') > SettingsID.MaxNumberLateFees
					THEN 0
				ELSE
		 	 		0 -- charge MF if didn't pay but if they pay in full and on time no LF. 
		 	 	END
