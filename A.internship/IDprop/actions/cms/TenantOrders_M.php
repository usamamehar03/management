...
function addOrder($id, $data,$maintenanceid){
	global $CONNECTION;
	$out = FALSE;
	$sql3= "INSERT INTO `TenantOrdersID` (`User_ID`,`MaintenanceType_ID`,`Details`,`Urgency`,`Availability`)
	VALUES (:user_id,:maintenanceType_id,AES_ENCRYPT(:details, '".$GLOBALS['encrypt_passphrase']."'),:urgency,AES_ENCRYPT(:availability, '".$GLOBALS['encrypt_passphrase']."'))";
