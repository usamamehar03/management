...
function addinvoice_maintenanceid($user_id,$maintenanceOrders_id)
{
	global $CONNECTION;
	$out = FALSE;
	$sql3= "UPDATE InvoiceID SET MaintenanceOrder_ID=:maintenanceOrders_id
...
// print_r(addinvoice_maintenanceid(1000001328,1));
