...
// AND  NOT EXISTS( SELECT 1 FROM PaymentRequestID WHERE PaymentRequestID.Invoice_ID=InvoiceID.ID AND (CURDATE() - `PaymentRequestID`.`DueDate`) <1)
//  		) OR (CURDATE() - `PaymentRequestID`.`DueDate`)=1 
//invoice setup
