...
if( isset($_POST['act']) && ($_POST['act']=='GetPropertyID') ){
	...
	// $id=TenantOrderFeedback\getsupplierid($_SESSION['userID']);
	$res['order']=TenantOrderFeedback\getTenantOrderid(1000000500);
	$res['propert_adress']=TenantOrderFeedback\getpropertyid(1000001282);
