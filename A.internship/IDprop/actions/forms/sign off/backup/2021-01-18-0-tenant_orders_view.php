...
if( isset($_POST['act']) && ($_POST['act']=='GetTenantData') ){
	...
	if($_SESSION['user_type'] == 'SeniorManagement' || 'Management' || 'PropertyManager' || 'AdminOps'){
		...
		$res['order'] = TenantOrdersView\getTenantOrderid($id);
		$res['name'] = TenantOrdersView\getName($id);
		$res['property_id'] = TenantOrdersView\getpropertyid($id,$PropertyManagment_id);
