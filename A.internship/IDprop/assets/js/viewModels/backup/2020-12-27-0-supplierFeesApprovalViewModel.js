define(['knockout', 'jquery', 'moment', 'bootstrap', 'notify', 'modal', 'timedUpdate'], function (ko,$,moment){
	...
	function supplierFeesApprovalViewModel() {
		...
		function addSupplierFeesApproved(o){
			var d = $.Deferred();
			$.post( '../actions/forms/supplier_fees_approval.php', { 'act':'addSupplierFeesApproved', 'data':o})
			// $.post( '../actions/forms/supplier_fees_approval.php', { 'act':'addSupplierFeesApproved', 'data':o,
		...
		function getSupplierFees(){
			var d = $.Deferred();
			$.post( '../actions/forms/supplier_fees_approval.php', { 'act':'getAllSupplierFees'})
			// $.post( '../actions/forms/supplier_fees.php', { 'act':'getAllSupplierFees',
			//'FORM_TOKEN':FORM_TOKEN})
			.done(function( data ) {
				data=JSON.parse(data);
				if( data )
		...
		function diplayformdata()
		{
			...
			self.fixedRates(suppliers()[supplierindex()].SupplierHasFixed=='1' ? 'Yes' : 'No');
		...
		{
			var d = $.Deferred();
			$.post('../actions/forms/supplier_fees_approval.php', { 'act':'getSupplierjobs','data':supplierid})
			// $.post( '../actions/forms/supplier_fees.php', { 'act':'getAllSupplierFees',
			//'FORM_TOKEN':FORM_TOKEN})
			.done(function( data ) {
				alert(data);
