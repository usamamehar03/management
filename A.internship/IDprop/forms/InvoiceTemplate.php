...
if($_SESSION['user_type'] != 'SeniorManagement' && $_SESSION['user_type'] !='PropertyManager' && $_SESSION['user_type'] !='Finance_SM' && $_SESSION['user_type'] !='Finance' && $_SESSION['user_type'] !='Supplier_SM'){
	header("Location: ../noPerms.php");
	die();
}
$token = userActions\tokenGenerate();
echo '<script type="text/javascript"> var FORM_TOKEN = "'.$token.'";</script>';
echo '<script type="text/javascript"> var user_type = "'.$_SESSION['user_type'].'";</script>';
echo'<script>';
                    ...
                    <form class=" mx-auto ">
                        ...
                        <div class="form-row">
							<div class=" form-group col-md-6">
								...
								<input class="form-control p-4 input" type="text" id="templateName" data-bind="value:templateName" required>
							...
							<div class="form-group col-md-6">
								...
								<select name="taxName" id="taxName" class="custom-select custom-select-lg input" data-bind="value:taxName" required>
							...
							<div class=" form-group col-md-6">
								...
								<label class="" for="taxRate">Enter Tax Rate <span style="color: #ff0000"><strong><sup>* </sup></strong></span>&emsp;(If Tax=0% enter 0)</label>
								<input class="form-control p-4 input" type="text" id="taxRate" data-bind="value:taxRate" required>
							...
							<div class="form-group col-md-6 ">
										<label for="client" class="">Client Type<span style="color: #ff0000"><strong><sup>*</sup></strong></span></label>
										<select name="client" id="client" class="custom-select custom-select-lg input" data-bind="options:clientlist,
					                    value: selectedclient,
					                    optionsText: 'name',
					           			optionsCaption: 'Select Client Type'">			
										</select>
										<div id="client_typeError" class="error"></div>  				
							</div>
							<div class="form-group col-md-6 ">
										<label for="name" class="">Name<span style="color: #ff0000"><strong><sup>*</sup></strong></span></label>
										<select name="name" id="name" class="custom-select custom-select-lg input" data-bind="options:namelist,
					                    value: selectedname,
					                    optionsText: 'name',
					           			optionsCaption: 'Select Client Name'">			
										</select>
										<div id="owner_idError" class="error"></div>   				
							</div>		
