        ...
        <div class=" m-auto" style="max-width: 780px;">
            <div class=" card">
                    ...
                    <form class=" mx-auto ">
                        ...
                        <div class="form-row">
							...
							<div class=" form-group col-md-6">
                                ...
                                <input class="form-control errorhandler custom-select-lg" type="date" id="schedule" data-bind="value:schedule" required>
								<div id="scheduleerr" class="error" style="font-size: 18px !important"></div>	
							</div>
                        </div>
                        <div class="form-row ">
                        <div class="d-flex  col-md-12 p-0">
                           	<div class=" form-group flex-fill pr-1 pl-1 col-md-6" data-bind="visible:isbuilding">
							...
							<div class=" form-group flex-fill pl-2 pr-2">
              ...
              <div>
                        ...
                        <div class="mt-4">
                            <button class="btn btn-secondary  pl-4 pr-4 font-weight-bold" data-bind="click:next" >next</button>
