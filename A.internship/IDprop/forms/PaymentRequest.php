...
echo $_SERVER['REQUEST_URI'].$_SERVER['SERVER_NAME'];
                    ...
                    <form class=" mx-auto ">		
                        ...
                        <div class="form-row">
							...
							<div class="d-flex col-md-12 p-0">
								...
								<div data-bind="visible:isnew_invoice" class=" form-group flex-fill pl-1 pr-1 col-md-6">
									<label class="" for="Type">Purpose</label>
									<select name="purpose" id="purpose" class="custom-select custom-select-lg data_input" data-bind=" value:purpose ,options:purposelist,  optionsText: 'name', optionsCaption: ' '">
									</select> 
							...
							<div class=" form-group col-md-12">
								...
								<input class="form-control p-4 data_input" type="text" id="description" data-bind="value:description">
								<div id="descriptionError" class="error" style="font-size: 18px!important"></div>    
							</div>
