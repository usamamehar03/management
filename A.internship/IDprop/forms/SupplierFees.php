            ...
            <div class=" card">
                ...
                <div class="p-4" style="height: 440px; overflow-y: scroll;">
                    <form class=" mx-auto" method="post">
                        ...
                        <div class="form-row" data-bind="visible:hidetop">
							<div class="form-group col-md-12">
								...
								<select name="maintenanceType" id="maintenanceType" class="custom-select custom-select-lg data_input" data-bind="value:maintenanceType">
									<option value=""></option>
							...
							<div class="form-group col-md-6">
								...
								<input class="form-control data_input p-4" type="text" id="callOutCharge" data-bind="value:callOutCharge" required>
							...
							<div class="form-group col-md-6">										
								...
								<select name="billingIncrement" id="billingIncrement" class="custom-select custom-select-lg data_input" data-bind="value:billingIncrement" required>
								<option value=""></option>
							...
							<div class=" form-group col-md-6">
								...
								<input class="form-control data_input p-4" type="text" id="hourlyRate" data-bind="value:hourlyRate" required>
							...
							<div class=" form-group col-md-6">
								...
								<input class="form-control data_input p-4" type="text" id="overtimeRate" data-bind="value:overtimeRate" required>
							...
							<div class=" form-group col-md-6">
								...
								<input class="form-control data_input p-4" type="text" id="weekendRate" data-bind="value:weekendRate" required>
							...
							<div class="form-group col-md-6">
								...
								<select name="fixedRates" id="fixedRates" class="custom-select data_input custom-select-lg" data-bind="value:fixedRates">
						...
						<div class="form-row" data-bind="visible:hideitems">
							<div class=" form-group col-md-4">
								<label class="" for="itemType1">Job Type<span style="color: #ff0000;"><strong><sup>*</sup></strong></span></label>
								<input class="form-control data_input p-4" type="text" id="itemType1" data-bind="value:itemType1" required>
							...
							<div class=" form-group col-md-4">
								...
								<input class="form-control data_input p-4" type="text" id="itemType1Min" data-bind="value:itemType1Min" required>
							...
							<div class=" form-group col-md-4">
								...
								<input class="form-control data_input p-4" type="text" id="itemType1Max" data-bind="value:itemType1Max" required>
