                    ...
                    <form class=" mx-auto ">
                        ...
                        <div class="form-row">
							...
							<div class="form-group col-md-12">
								...
								<textarea class="form-control input_data" name="supplierNotes" data-bind="value:finalsupplierNotes" id="supplierNotes" rows="5" required></textarea>
							...
							<div class="form-group col-md-6">
								...
								<select name="tenantdamage" id="tenantdamage" class="custom-select custom-select-lg input_data" data-bind="value:tenantdamage" required>
							...
							<div class="form-group col-md-6">
								...
								<input class="form-control p-4 input_data" type="text" id="InvoiceNotes" data-bind="value:InvoiceNotes">
							...
							<div class="form-group col-md-6">
								...
								<input class="form-control p-4 input_data" type="text" id="InvoiceRef" data-bind="value:InvoiceRef">
							...
							<div class="form-group col-md-6">
								...
								<input class="form-control p-4 input_data" type="text" id="Invoicenumber" data-bind="value:Invoicenumber">
								<div id="InvoicenumberError" class="error" style="font-size: 18px !important"></div>
							</div>
							<div class=" d-flex flex-column flex-md-row col-md-12">
								<div class=" form-group flex-fill pr-1">
									<label class="" for="Invoicedate">Invoice Due-Date<span style="color: #ff0000"><strong><sup>*</sup></strong></span></label>
									<input class="form-control custom-select-lg input_data" type="date" id="Invoicedate" data-bind="value:Invoiceduedate"> 
									<div class="error" id="InvoiceduedateError" style="font-size: 18px !important"></div>	
								</div>
								<div class="form-group flex-fill pl-md-2" data-bind="visible:ishours">
									<label class="Invo_label" for="billableHours">Billable Hours</label>					
									<input class="form-control p-4 input_data" type="text" id="billableHours" data-bind="value:billableHours">
							...
							<div class="form-group col-md-6" data-bind="visible:ishours">
								...
								<select name="minutes" id="minutes" class="custom-select custom-select-lg input_data" data-bind="value:minutes" >
						...
						<div class="form-row" data-bind="foreach:partlist">
							<div class="form-group col-md-4">
								<label class="Invo_label" for="partname">Part Name</label>					
								<input class="form-control p-4" type="text" id="partname" data-bind="value:partname" disabled>
							</div>
							<div class="form-group col-md-4">
								<label class="Invo_label" for="serialNumber">Serial Number</label>					
								<input class="form-control p-4 input_data" type="text" id="serialnumber" data-bind="value:serialnumber">
								<div data-bind="attr:{'id':serialid}" class="error" style="font-size: 18px !important"></div>
							</div>
							<div class=" form-group col-md-4">
								<label class="" for="warranty">Warranty</label>
								<input class="form-control custom-select-lg input_data" type="date" id="warranty" data-bind="value:warranty"> 
