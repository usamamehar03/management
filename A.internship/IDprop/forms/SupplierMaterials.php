                    ...
                    <form class=" mx-auto ">
                        ...
                        <div class="form-row"  data-bind="foreach: materialcost" >
                           ...
                           <div class=" form-group col-md-4">
								...
								<select name="aprovepart" id="aprovepart" class="custom-select custom-select-lg" data-bind="value:aprovepart, event: { change: partsaproval }" required>
                        ...
                        <div class="form-row" >
                           <div class=" form-group col-md-6">
                                <label  for="response">Accept Order?<span style="color: #ff0000"><strong><sup>*</sup></strong></span></label>					
                								<select name="fixedApproved" id="fixedApproved" class="custom-select custom-select-lg" data-bind="value:fixedApproved ,attr:{'disabled':isorder}">
