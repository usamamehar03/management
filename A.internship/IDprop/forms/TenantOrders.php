        ...
        <div class=" m-auto" style="max-width: 780px;">
            <div class=" card">
                ...
                <div class="p-4" style="height: 440px; overflow-y: scroll;">
                    <form class=" mx-auto" id="tenantform" method="post">
                        <div class="form-row">
							<div class="form-group col-md-6">
								...
								<select name="maintenanceType" id="maintenanceType" class="custom-select custom-select-lg input_data" data-bind="value:maintenanceType">
							...
							<div class="form-group col-md-6">
								...
								<select name="urgent" id="urgent" class="custom-select custom-select-lg input_data" data-bind="value:urgent">
							...
							<div class="form-group col-md-12">
								...
								<textarea class="form-control input_data" name="details" data-bind="value:details" id="details" class="form-control invo_input" rows="5" ></textarea>
							...
							<div class="form-group col-md-12">
								...
								<textarea class="form-control input_data" name="availability" data-bind="value:availability" id="availability" class="form-control invo_input" rows="5" ></textarea>
