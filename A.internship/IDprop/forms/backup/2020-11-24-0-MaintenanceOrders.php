		...
		<div class="" style="background-color:transparent !important;">		
			...
			<div>
				...
				<div class="col-md">					
					...
					<select name="overtime" id="overtime" class="invo_select hourrate" data-bind="value:overtime" required>
					<option value="0">No</option>
					<option value="1">Yes</option>															
					</select> 						
				</div>	
				<div class="col-md">					
					...
					<select name="weekend" id="weekend" class="invo_select hourrate" data-bind="value:weekend" required>
					<option value="0">No</option>
					<option value="1">Yes</option>															
					</select>						
				</div>	
