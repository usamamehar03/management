		...
		<?php # echo 'For our 1st use case we want to enter test9950@hirefaster.tech and automatically display tenant name. We leave Invoice and Client as null in the DB.';?>		
			...
			<div>
				...
				<div class="col-md">					
					...
					<select name="client" id="client" class="invo_select " data-bind=" value:selectedclient ,options:clientlist,  optionsText: 'id', optionsCaption: ''">
				...
				<div style="width: 97%; padding-left: 0%;padding-right: 2%;float: left;" >
					<div class="col-md" style="width: 47%">					
						...
						<input class="invo_input bymail" type="text" id="email" data-bind="value:email,  event: { keyup: displayname } ,valueUpdate: 'afterkeydown', attr : {'disabled' : isDisabled}">
						<div class="error" id="emailError" style="font-size: 18px!important"></div>
					</div>
					<div class="col-md" style="width: 47%">					
						<label class="Invo_label" for="name">Client Name</label>					
						<input class="invo_input" type="text" id="name" data-bind="value:clientname, attr : {'disabled' : isDisabled}" disabled>
				...
				<div class="col-md" style="">					
					...
					<input class="invo_input" type="text" id="amount" data-bind="value:amount, attr : {'disabled' : isamount}">
					<div class="error" id="amountError"></div>
				</div>				
				<div class="col-md" style="">					
					<label class="Invo_label" for="dueDate">Due Date</label>					
					<input class="invo_input" type="date" id="dueDate" data-bind="value:dueDate, attr : {'disabled' : isduedate}">
