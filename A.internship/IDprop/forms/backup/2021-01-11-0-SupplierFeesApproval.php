		...
		<div class="" style="background-color:transparent !important;">		
			...
			<div style="overflow-y:scroll; height:400px; margin-bottom: 2%">				
				...
				<div class="col-md" style="width: 95%;">										
					...
					<input class="invo_input" type="text" id="supplierName" data-bind="value:company" disabled>				
				</div>
				...
				<div class="col-md" data-bind="visible:isavail">					
				...
				<div class="col-md" style="width: 93% !important; margin-top: 2%;">					
					<label for="Note" class="Invo_label">Note<span style="color: #ff0000"></label>
					<textarea data-bind="value:Note" style="height: 82px"  class="invo_input" type="text" id="Note"></textarea>
				</div>
				<br>					
			</div>
		</div>
