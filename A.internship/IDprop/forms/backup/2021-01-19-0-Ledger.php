	...
	<?php # echo 'If "Sort=alphabetical show top table and hide bottom table; else hide top table and show table below'.;?>
			...
			<thead>
				...
				<tr>				
					...
					<th style="text-align:center; width:9% ! important">Assigned</th>
		...
		<?php # echo '	<td><span data-bind="text:$index()+1 style="text-align:center"></span></td>'.;?>
				<td><input type="date" id="date" name="date" class="input" data-bind="value:date" style="text-align:center" disabled></td>
				<td>
					<select name="assign" id="assign" class="intem_select" data-bind="value:assign" disabled>					
				...
				<td>
					<input type="text" name="description" id="description" class="input" data-bind="value:description" style="text-align:center" disabled>
					<span class="error" id="descriptionError" style="font-size: 18px!important ;color: #2A88AD"></span>
				</td>
				<td>										
					<select name="ledger" id="ledger" class="intem_select" data-bind="event: { input: loaddata }, value:selectedledger" required>
				...
				<td >
					<input type="text" name="Ref" id="Ref" class="input" data-bind="value:Ref" style="text-align:center" disabled>
					<span class="error" id="refError" style="font-size: 18px!important ;color: #2A88AD"></span>
				</td>
				<td >
					<input type="text" name="Debit" id="Debit" class="input" data-bind="value:Debit" style="text-align:center"disabled>
					<span class="error" id="debitError" style="font-size: 18px!important ;color: #2A88AD"></span>
				</td>
				<td>
					<input type="text" name="Credit" id="Credit" class="input" data-bind="value:Credit" style="text-align:center" disabled>
...
<?php # echo 'https://www.codeproject.com/tips/786357/knockout-data-binding-to-table-with-rowspan	'.;?>	
			...
			<tr>
			<?php # echo '<td><span data-bind="text:$index()+1 style="text-align:center"></span></td>'.;?>
				<td><input type="date" class="input" name="date" id="date" data-bind="value:date" style="text-align:center" disabled></td>
				<td>
					<select name="assign" id="assignp" class="intem_select" data-bind="value:assign" disabled>					
					<option value="">optional</option>
					<option value="building_id">Building</option>
					<option value="property_id">Property</option>
					<option value="landlord_id">Landlord</option>
				...
				<td>
					<input type="text" name="description" id="descriptionp" class="input" data-bind="value:description" style="text-align:center" disabled>
					<span class="error" id="descriptionpError" style="font-size: 18px!important ;color: #2A88AD"></span>
				</td>
				<td>										
					<select name="ledger" id="ledgerp" class="intem_select" data-bind="event: { input: loaddata }, value:selectedledger" required>					
					<option value="">Select Chart of Accounts</option>
				...
				<td >
					<input type="text" name="Ref" id="Refp" class="input" data-bind="value:Ref" style="text-align:center" disabled>
					<span class="error" id="refpError" style="font-size: 18px!important ;color: #2A88AD"></span>
				</td>
				<td >
					<input type="text" name="Debit" id="Debitp" class="input" data-bind="value:Debit" style="text-align:center" disabled>
					<span class="error" id="debitpError" style="font-size: 18px!important ;color: #2A88AD"></span>
				</td>
				<td>
					<input type="text" name="Credit" id="Creditp" class="input" data-bind="value:Credit" style="text-align:center" disabled>
