...
<!-- 				<h3>Add Invoice Template</h3>
 ...
 -->				
				...
				<div class="col-sm-4 dropdowns">				
					...
					<select name="client" id="client" class="intem_select inputs" data-bind="value:selectedclient ,options:clientlist,  optionsText: 'name', optionsCaption: ''" required>
				...
				<div class="form-group col-md" style="padding-left: 10%;">
					...
					<input class="inputs" type="invoiceNumber" name="invoiceNumber" data-bind="value:invoiceNumber" id="invoiceNumber" required>
				...
				<div class="col-md">			
					...
					<select name="template" id="template" class="intem_select inputs" data-bind="value:selectedtemplate ,options:template,  optionsText: 'name', optionsCaption: ''" required>
				...
				<div class="col-md">				
					...
					<select name="terms" id="terms" class="intem_select inputs" data-bind="value:terms" required>
					<option value=""></option>
				...
				<div class="form-group mails">
					...
					<input class="Intem_input inputs" type="date" name="invoiceDate" id="invoiceDate" data-bind="value:invoiceDate" required>
					<div class="error" id="invoiceDateError" style="font-size:18px !important"></div>	
					<?php # echo 'must be today or later;?>	
				</div>
				&emsp;&emsp;&emsp;&emsp;
				<div class="form-group mails">
					<label class="intem_label">Due Date</label>
					<input class="Intem_input inputs" type="date" name="dueDate" id="dueDate" data-bind="value:dueDate" required>
...
<!-- 				<tr>
 ...
 -->		<!-- /ko -->	
  			...
  			<tbody data-bind="foreach:subinvoice_list">
				<tr>
					<td data-label="ReferenceNumber">
						<input class="Intem_input inputs" type="text" name="ReferenceNumber" data-bind="value:ReferenceNumber"/>
						<div class="error" data-bind="attr: {id: 'ReferenceNumber'+$index()+'Error'}" style="font-size: 18px!important"></div>
					</td>															
					<td data-label="Service">
						<input class="Intem_input inputs" type="text" name="service" data-bind="value:service"/>
						<div class="error" data-bind="attr: {id: 'service'+$index()+'Error'}" style="font-size: 18px!important"></div>
					</td>	

					<td data-label="Description">
						<input class="Intem_input inputs" type="text" name="description" data-bind="value:description"/>
						<div class="error" data-bind="attr: {id: 'description'+$index()+'Error'}" style="font-size: 18px!important"></div>
					</td>

					<td data-label="Amount">
						<input class="Intem_input inputs" type="text" name="amount" data-bind="value:amount"/>
						<div class="error" data-bind="attr: {id: 'amount'+$index()+'Error'}" style="font-size: 18px!important"></div>
					</td>

					<td><button data-bind="click:remove_subinvoice">&#10006;</button></td>					
				</tr>
				<!-- <tr>
					<td data-label="ReferenceNumber"><input class="Intem_input" name="ReferenceNumber" data-bind="value:ReferenceNumber"/></td>															
		...
		<button class="btn btn-success intem_btn"  data-bind="click:add_subinvoice" >Add Another</button>
	</div>
	<br>
