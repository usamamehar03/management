		...
		<?php # echo 'For our 1st use case we want to enter test9950@hirefaster.tech and automatically display tenant name. We leave Invoice and Client as null in the DB.';?>		
			...
			<div>
				...
				<div class="col-md">					
					...
					<select name="ownertype" id="ownertype" class="invo_select " data-bind=" value:ownertype">
				...
				<div class="col-md">					
					...
					<select name="ownerid" id="ownerid" class="invo_select " data-bind=" value:selectedowner ,options:ownerList,  optionsText: 'address', optionsCaption: ''">				
					</select>
