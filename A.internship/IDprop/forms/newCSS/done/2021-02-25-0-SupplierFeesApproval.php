                    ...
                    <form class=" mx-auto ">
                        ...
                        <div class="form-row">
							...
							<div class=" form-group col-md-6">
								...
								<input class="form-control p-4" type="text" id="supplierName" data-bind="value:supplierName" disabled>
							</div>
							<div class=" form-group col-md-6">
							...
							<div class=" form-group col-md-6">
								...
								<input class="form-control p-4" type="text" id="fixedRate" data-bind="value:fixedRate" disabled>
							</div>
							<!-- display error fixer  dont remove-->
							<!-- work here -->
							<div class=" form-group col-md-6" data-bind="foreach: joblist, visible: isvisible">
								<label class="" for="itemType1"></label>
								<input class="form-control p-4" type="text" id="itemType1" data-bind="value:itemType1" disabled>
						...
						<div class="form-row">
							<div class=" form-group col-md-6" data-bind="foreach: joblist, visible: isvisible">
								...
								<input class="form-control p-4" type="text" id="itemType1Min" data-bind="value:itemType1Min" disabled>
							...
							<div class=" form-group col-md-6" data-bind="foreach: joblist, visible: isvisible">
								...
								<input class="form-control p-4" type="text" id="itemType1Max" data-bind="value:itemType1Max" disabled>
							...
							<div class="form-group col-md-6">
								...
								<select name="approved" id="approved" class="custom-select custom-select-lg" data-bind="value:approved" required>
							...
							<div class="form-group col-md-12">
								...
								<textarea class="form-control" name="notes" data-bind="value:Note" id="Note" class="form-control invo_input" ></textarea>
							</div>	
						</div>
