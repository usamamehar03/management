                ...
                <div class="p-4" style="height: 440px; overflow-y: scroll;">
                    <form class=" mx-auto ">
                        ...
                        <div class="form-row">	
							...
							<div class=" form-group col-md-6">
								...
								<input class="form-control custom-select custom-select-lg" type="date" id="schedule" data-bind="value:schedule" required> 
							</div>
							<div class="form-group col-md-6">
								<label for="response" class="Invo_label">Accept Order?<span style="color: #ff0000;"><strong><sup>*</sup></strong></span></label>					
								<select name="response" id="response" class="custom-select custom-select-lg" data-bind="value:response">
							...
							<div class="form-group col-md-6">
								...
								<select name="hourly" id="hourly" class="custom-select custom-select-lg" data-bind="value:hourly">
								<option value="type"></option>
									<option value="hourly">Hourly</option>	
									<option value="fixed">Fixed Rate</option>
								</select> 	
							</div>
							<div class="form-group col-md-6" style="" data-bind="visible:isavail">
								<label class="Invo_label" for="fixedQuote">Fixed Rate Quote</label>					
								<input class="form-control p-4" type="text" id="fixedQuote" data-bind="value:fixedQuote">
							...
							<div data-bind="foreach: materialcost">
								<div>
								<div class="form-group col-md-6" style="" data-bind="visible:isavail">
								<label class="Invo_label" for="materialCost_ID" data-bind="text:label"></label>					
								<input class="form-control p-4" type="text" id="itemType1" data-bind="value: name">
							...
							<div class="form-group col-md-6">
								...
								<input class="form-control p-4" type="text" id="price" data-bind="value: rate" disabled>
					...
					<div class="form-row">
						<div class=" form-group col-md-6">
							...
							<input class="form-control custom-select custom-select-lg" type="date" id="startdate" data-bind="value:startdate" required> 
						...
						<div class=" form-group col-md-6">
							...
							<input class="form-control custom-select-lg" type="time" id="starttime" data-bind="value:starttime" required> 
						...
						<div class="form-group col-md-6">
							...
							<select name="supplierStaff_ID" id="supplierStaff_ID" class="custom-select custom-select-lg" data-bind=" value: selectedstaff, options:stafflist,  optionsText: 'name', optionsCaption: ''">
							</select> 
							<div id="staffError" class="errro" style="font-size: 18px !important"></div> 	
						</div>
						<div class="form-group col-md-12">
							<label class="Invo_label" for="notes">Supplier Notes</label>					
							<textarea class="form-control" name="supplierNotes" data-bind="value:supplierNotes" id="supplierNotes" class="form-control invo_input" rows="4"></textarea>
