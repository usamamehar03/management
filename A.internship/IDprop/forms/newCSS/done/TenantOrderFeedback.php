                    ...
                    <form class=" mx-auto ">
						...
						<div class="form-row">
							<div class="form-group col-md-8">
								...
								<select name="ratingPropertyManager" id="ratingPropertyManager" class="custom-select custom-select-lg" data-bind="value:ratingPropertyManager" required>
								<option value="type">Select Rating</option>
							...
							<div class="form-group col-md-8">
								...
								<select name="ratingSupplier" id="ratingSupplier" class="custom-select custom-select-lg" data-bind="value:ratingSupplier" required>
								<option value="type">Select Rating</option>
									<option value="5">Excellent</option>	
									<option value="4">Very Good</option>
									<option value="3">Good</option>
							...
							<div class="form-group col-md-12">
								...
								<textarea class="form-control" name="tenantFeedback" data-bind="value:tenantFeedback" id="supplierNotes" class="form-control invo_input" rows="5" required></textarea>
