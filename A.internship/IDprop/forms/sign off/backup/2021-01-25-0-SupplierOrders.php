...
<!-- <hr style="margin: 55%;"> -->
					...
					<div class="modal-footer">
						<button class="btn btn-success invo_btn"  data-bind="click:addmaterial">Add Another Material Cost</button>
						<button class="btn btn-success invo_btn"  data-bind="click:add, enable:isavailSupplier" >Submit</button>
					</div>		
		</div>		
		<div>
	</div>
