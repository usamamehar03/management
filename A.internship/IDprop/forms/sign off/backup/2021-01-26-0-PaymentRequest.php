			...
			<div>
				...
				<div style="width: 97%; padding-left: 0%;padding-right: 2%;float: left;" >
					<div class="col-md" style="width: 47%">					
						...
						<input class="invo_input disable bymail" type="text" id="email" data-bind="value:email,  event: { keyup: displayname } ,valueUpdate: 'afterkeydown', attr : {'disabled' : isDisabled}">
				...
				<div class="col-md" style="">					
					...
					<input class="invo_input disable" type="text" id="amount" data-bind="value:amount, attr : {'disabled' : isamount}">
