	...
	<div class="form-style-10 modal cform" style="max-width: 450px;min-width: 450px;width:35%;margin-top: 50px;margin:auto;">
		...
		<div class="" style="background-color:transparent !important;">					
			<div>
				...
				<div class="col-md" style="width: 95%;">					
					<label for="CAM" class="Invo_label">CAM?<span style="color: #ff0000"><strong><sup>*</sup></strong></span></label>
					<select name="CAM" id="CAM" class="invo_select cam" data-bind="value:cam" required>
				...
				<div class="col-md">					
					...
					<select name="urgent" id="urgent" class="invo_select hourrate" data-bind="value:urgent" required>
					<option value="0">No</option>
					<option value="1">Yes</option>															
					</select>
				...
				<div class="col-md" style="width: 97%;">
					<div class="col-md" style="width: 47%;padding-left: 0%!important">
						<label for="property_ID" class="Invo_label">Select building<span style="color: #ff0000"><strong><sup>*</sup></strong></span></label>					
							<select name="building_ID" id="building_ID" class="invo_select hourrate" data-bind=" value:selectedbuildig ,options:buildinglist,  optionsText: 'name', optionsCaption: ''" required>					
							</select> 
					...
					<div class="col-md" style="width: 47%;">
						<label for="property_ID" class="Invo_label">Select Property<span style="color: #ff0000"><strong><sup>*</sup></strong></span></label>					
							<select name="property_ID" id="property_ID" class="invo_select hourrate" data-bind=" value:slectedproperty ,options:propertylist,  optionsText: 'name', optionsCaption: ''" required>					
							</select> 
			...
			<div   class="row"  style="padding-left: 0%;padding-right: 2%;float: left;margin-bottom: 3%; width: 100%">
				<div data-bind="foreach: feelist, visible: isvisible">			
					...
					<div class="col-md" style="">					
						<label class="Invo_label" for="supplier1HourlyRate" data-bind="text:ratelabel"></label>					
				...
				<label for="itemType_ID" class="Invo_label">Select Job Type<span style="color: #ff0000"><strong><sup>*</sup></strong></span></label>					
					<select name="itemType_ID" id="itemType_ID" class="invo_select fixedrate" data-bind="value: selectedjob, options:jobtypelist,  optionsText: 'jobtype', optionsCaption: '' " required>
				...
				<div class="form-group">
					...
					<textarea name="notes" data-bind="value:notes,  valueUpdate: ['afterkeydown', 'input']" id="notes" class="form-control invo_input" rows="10" required></textarea>
		...
		<div class="col-md" style="width: 100%; padding-left: 0%!important" data-bind="visible:isdecision">					
			<label class="Invo_label" for="decisionmsg">Decision</label>					
			<textarea class="invo_input" id="decision" data-bind="value:decisionmsg" disabled>
			</textarea>
			<div class="col-md">
				<button class="btn btn-success invo_btn" data-bind="click:decide">YES</button>
				<button class="btn btn-success invo_btn" data-bind="click:reject">NO</button>
			</div>
		</div>
	</div>
	</div>	
