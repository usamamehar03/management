...
<body id="profileViewPage">
	...
	<div >
		...
		<div class="logo mr-auto">
			<a href="ProfilePortal.html"><img src="images/logo.png" alt="IDprop" border="0" class="customLogo"/></a>
		</div>
		<!-- Navigation -->
...
<center style="margin-top: 140px;width: 100%:">
	<div class="col col-6" >
		<a id="m_1_2" class="project-item completed" >
			...
			<span class="title">You are not logged in.</span>
			<span>Please log in.</span>
			<!-- <a href="../Authentication/secsign/login.php"><button class="btn btn-primary">Login</button></a> -->
			<a href="testUsers.php"><button class="btn btn-primary">Login</button></a>
		</a>
	</div>
</center>
